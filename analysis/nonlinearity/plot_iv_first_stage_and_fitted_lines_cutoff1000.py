...
OUT_FIRST_STAGE = OUT_DIR / "iv_first_stage_cutoff1000_global.svg"
OUT_FITTED_ALL = OUT_DIR / "iv_fitted_indownhat_vs_depvars_cutoff1000_global.svg"
...
def plot_fitted_lines(rank_map):
    ...
    fig.suptitle("IV Nonlinear Fitted Curve: ind_own_hat vs Dependent Variables (Cutoff=1000, Global)", fontsize=12)
    fig.tight_layout()
